...
# 테스트할 경로 설정
ROOT_FOLDER = (
    r"C:\\Users\\pps\\Desktop\\00.ruah\\001.pps\\002.정비시스템\\정비지원특화모델\\test"
)
...
async def main():
    ...
    async with stdio_client(server_params) as (read, write):
        async with ClientSession(read, write) as session:
            ...
            logger.info("[Primary Image Description]", resp)
